function [uPur,Vset] = maxTraj(SpurT,SevaT,gameStateT,miscParams,uPset,heurTypeStruc,muVeck,costType)
...
elseif strcmp(costType,'entropy')
    ...
    for ip=1:nUset
        ...
        for ikUxT=1:nU2
            ...
            x3ent = f_dynEvaQuad(x2ent{ik,1},uEvaTrueTemp,dt,zeros(2,1));
            zMeas = x3ent;
