...
file_input_string='nnqr2v1dat';
nummats=3;
full_nn_datfile='nnqr2v1TrainData.mat';
...
if mode==0
    ...
    datset=zeros(26,1,1,indatlength*tsim*nummats);
    solsset=zeros(1,1,6,indatlength*tsim*nummats);
    
    n=0;
    nu=6; %total length of stacked u-vec
    offset=10;
    offset_u=0;
    offx=0;
    offv=0;
    offset_multiply_qqrr=0.1;
    offset_vec=[offx;offx;offv;offv; offx;offx;offv;offv; offx;offx;offv;offv];
    for il=1:nummats
        for ij=1:indatlength
            ...
            for ik=1:tsim
                ...
                datset(1:12,1,1,n)=x0+offset_vec;
                datset(13:end,1,1,n)=qqrr*offset_multiply_qqrr;
                solsset(1,1,:,n)=[up;ue]'+offset_u*ones(1,nu);
            end
        end
...
network = [
    matrixInputLayer([26 1 1],'Normalization','none')
