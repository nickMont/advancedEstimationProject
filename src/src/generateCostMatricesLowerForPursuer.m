function [Jpur,Jeva,uMatCellP,uMatCellE] = generateCostMatricesUpperForPursuer(Spur, Seva, gameState)
%inputs:
...
[xPurCell, uMatCellP] = generateStateMatFromPairingsLowerForPursuer(pairingsP,Spur,Seva,gameState);
[xEvaCell, uMatCellE] = generateStateMatFromPairingsLowerForPursuer(pairingsE,Spur,Seva,gameState);
